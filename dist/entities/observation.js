...
__decorate([
    typeorm_1.ManyToOne(type => individual_1.individual, individual_id => individual_id.observations),
...
__decorate([
    typeorm_1.OneToMany(type => answer_1.answer, answers => answers.observation_id),
