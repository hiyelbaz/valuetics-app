...
var BaseController = /** @class */ (function () {
    function BaseController(entity) {
        // this.repository = new EntityRepository<T>(entity)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.repository.findByIds([req.params.id]).catch(function (err) { console.log(err.message); })];
                    case 1:
                        query = _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.repository.find().catch(function (err) { console.log(err.message); })
                        // if (p1) {
                    ...
                    case 3:
                        query = _a.sent();
                        _a.label = 4;
                    case 4: return [2 /*return*/, query];
                }
            });
        });
    };
    BaseController.prototype.getBurak = function () {
        return { name: "Burak Büyükatlı" };
    };
    BaseController.prototype.put = function (entity) {
